...
{    [Serializable]
    public class PlayerState
    {
        ...
        public PlayerState(int id, Vector3 pos, float rotation, bool walking, bool running, bool aiming, bool crouching, bool grounded, bool reloading, int sCount, int jCount)
        {
            playerId = id;
            posX = pos.x;
            posY = pos.y;
